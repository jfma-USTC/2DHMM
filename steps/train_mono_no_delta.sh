...
$norm_vars && cmvn_opts="--norm-vars=flase $cmvn_opts"
echo $cmvn_opts  > $dir/cmvn_opts # keep track of options to CMVN.

#feats="ark:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | add-deltas --delta-order=0 ark:- ark:- |"
...
# Note: JOB=1 just uses the 1st part of the features-- we only need a subset anyway.
  ...
  #feat_dim=`feat-to-dim scp:$sdata/1/feats.scp ark:- | - 2>/dev/null`
