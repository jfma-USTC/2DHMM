...
die "perl *.pl <in-file-list> <output-dir> [<shift_right==5> <shift_down==5>]\n".
	...
	"e.g. perl ".__FILE__." train_file_list.txt train_feature 5 -1\n" if not (@ARGV == 2 or @ARGV == 3 or @ARGV == 4);
