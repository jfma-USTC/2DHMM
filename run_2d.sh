...
train_nj=20
decode_nj=8
train_data=./data_2d/train_8r_8d
test_data=./data_2d/test_8r_8d
#train_cmd=
#decode_cmd= 
topo_2d=./lang/lang_2d/topo_2d  # topo file for 2D situation
lang=./lang/lang_2d
exp_dir=./exp_2d/true_2d_r8_d8_11rows_after_force_state_of_lastrowcol
...
if [ $pre_lang -ne $zero ]; then
	utils/prepare_lang.sh --position-dependent-phones false --num-sil-states 5 --num-nonsil-states 5 \
		lang/lang_2d/dict "<unk>" lang/lang_2d/temp $lang
	if [ -f $topo_2d ]; then 
