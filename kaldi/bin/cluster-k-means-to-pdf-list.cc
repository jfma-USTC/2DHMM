...
int main(int argc, char *argv[]) {
	...
	try {
		...
		const char *usage =
			...
			"Usage:  cluster-k-means-to-pdf-list [options] <tree-stats-in> <pdf-list>\n"
			"e.g.: \n"
			" cluster-k-means-to-pdf-list --max-clust=200 1.tacc pdf-list\n";
		...
		ClusterKMeansOptions kopts;
		ClusterKMeans(points, max_clust, NULL, &assignment, kopts);
