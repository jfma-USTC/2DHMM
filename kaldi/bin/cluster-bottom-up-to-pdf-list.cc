...
int main(int argc, char *argv[]) {
	...
	try {
		...
		const char *usage =
			...
			"Usage:  cluster-bottom-up-to-pdf-list [options] <tree-stats-in> <pdf-list>\n"
			"e.g.: \n"
			" cluster-bottom-up-to-pdf-list --max-clust=200 1.tacc pdf-list\n";
		...
		ClusterBottomUp(points, cluster_thresh, max_clust, NULL, &assignment);
