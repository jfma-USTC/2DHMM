...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    const char *usage =
        ...
        "Usage:  gmm-init-model-from-pdf-list-2D [options] <pdf-list> <tree-stats-in> <topo-file> <model-out>\n"
		"NOTE that each line of <pdf-list> is a vector of [phone_id hmm_state], and they share the same pdf.\n"
		"e.g. 4 0 18 0 22 2 \n 4 1 6 1 14 1 \n ..."
        "e.g.: \n"
        "  gmm-init-model-from-pdf-list-2D pdf-list-file treeacc topo 1.mdl\n";
	...
	TransitionModel_2D trans_model(pdf_list, topo);
